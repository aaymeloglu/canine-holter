...
- Thresholds (PVC prematurity/width ratios, brady/tachy/pause limits) are provisional and per-recording, not clinically calibrated. Calibration waits on real cardiologist-reviewed Teeny recordings.
